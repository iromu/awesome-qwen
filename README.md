...
|-------|-------------|---------|------|
| [agentic-patterns-core](skills/agentic-patterns-core) | The canonical reference for 21 agentic design patterns — prompt chaining, routing, parallelization, reflection, tool use, planning, memory, RAG, guardrails, and more | `1.0.0` | ![patterns](https://img.shields.io/badge/patterns-blue) ![agents](https://img.shields.io/badge/agents-blue) ![architecture](https://img.shields.io/badge/architecture-blue) |
...
| [embabel-agent](skills/embabel-agent) | Build agentic AI applications on the JVM with Embabel — a Spring-based framework for creating agents that mix LLM interactions with code, planning, and domain models. Covers @Agent/@Agentic annotations, GOAP/Utility planning, states, agentic tools, tool groups, ToolCallContext, subagents, LlmOptions, and testing | `1.0.0` | ![jvm](https://img.shields.io/badge/jvm-blue) ![spring](https://img.shields.io/badge/spring-blue) ![agents](https://img.shields.io/badge/agents-blue) |
| [embabel-chatbot](skills/embabel-chatbot) | Build agentic chatbots with RAG using Embabel — chatbot builder, chat memory, RAG sources, guardrails, reasoning/thinking, structured JSON output, chat extensions, chat actions/tool calling, and history persistence | `1.0.0` | ![jvm](https://img.shields.io/badge/jvm-blue) ![spring](https://img.shields.io/badge/spring-blue) ![chatbot](https://img.shields.io/badge/chatbot-blue) |
| [embabel-dice](skills/embabel-dice) | Build proposition-based knowledge graphs that give AI agents structured, confidence-weighted memory — proposition extraction, entity resolution, schema validation, deduplication, and projections to Neo4j/vector/Prolog | `1.0.0` | ![jvm](https://img.shields.io/badge/jvm-blue) ![spring](https://img.shields.io/badge/spring-blue) ![knowledge-graph](https://img.shields.io/badge/knowledge--graph-blue) |
| [embabel-drivine4j](skills/embabel-drivine4j) | Build type-safe graph database clients with Drivine4j for Neo4j, FalkorDB, Amazon Neptune, and Memgraph — composition over inheritance, @GraphView annotations, PersistenceManager Cypher API, GraphObjectManager DSL, and dirty tracking | `1.0.0` | ![jvm](https://img.shields.io/badge/jvm-blue) ![spring](https://img.shields.io/badge/spring-blue) ![graph-database](https://img.shields.io/badge/graph--database-blue) |
