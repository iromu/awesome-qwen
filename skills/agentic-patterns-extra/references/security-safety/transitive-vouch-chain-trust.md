...
- [AIP (Agent Identity Protocol)](https://github.com/nicksche/aip-identity) — Python SDK implementing Ed25519-based identity, signed vouches, and chain verification for AI agents.
