# Embabel Framework - Agent Skills Documentation

Source: https://docs.embabel.com/embabel-agent/guide/0.1.2-SNAPSHOT/reference/agent_skills/
and https://github.com/embabel/embabel-agent/tree/main/embabel-agent-skills

## Overview

Embabel implements the [Agent Skills](https://agentskills.io/home) specification for loading and using skills in agents.
